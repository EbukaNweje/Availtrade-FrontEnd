        ...
        <Container>
            <Wrapper>
                ...
                <Div2>
                    <Wrap>
                        <Icon>
                            <TfiAnnouncement   style={{width: "25px", height: "25px"}}/>
                        </Icon>
                    ...
                    <Wrap>
                        <Icon> 
                            <TfiLayoutSliderAlt   style={{width: "25px", height: "25px"}}/>
                        </Icon>
                ...
                <Div>
                    <Wrap>
                        <Icon><TfiComments style={{width: "25px", height: "25px"}}/></Icon>
                    ...
                    <Wrap>
                        <Icon>
                            <TfiCup style={{width: "25px", height: "25px"}}/>
                        </Icon>
