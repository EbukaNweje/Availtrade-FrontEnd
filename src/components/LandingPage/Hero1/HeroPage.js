  ...
  return (
    ...
    <Container>
            <LeftDiv>
                ...
                <Line></Line>
                <Content>Private equity firm Experttrades.org came up with a Balanced Asset Basket that allowed it to invest in cryptocurrency and other similar blockchain based industries. The company’s primary activity is focused on cryptocurrency domain such as field of exchange and stock markets.</Content>
                <ButtonHold>
                    <Getstarted>
